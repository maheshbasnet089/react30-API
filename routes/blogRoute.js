...
router.route("/blog/:id").get(catchAsync(blogController.getSingleBlog)).delete(catchAsync(blogController.deleteBlog)).patch(isAuthenticated, upload.single('image'), catchAsync(blogController.updateBlog))
